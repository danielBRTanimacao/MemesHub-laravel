...
<body>
    <form action="{{ route('register') }}" method="POST" class="d-flex justify-content-center align-items-center" style="height: 100dvh">
        @csrf
        <div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input name="password_confirm" type="password" class="form-control" id="secondPasswordId" required>
            </div>
